...
export const manychatAlternativePage: SeoPageConfig = {
  ...
  description:
    "VisibleTrader DM is for teams that do not need a broad chatbot builder. It turns keyword comments into Meta-compliant private replies, tracked links, campaign analytics, and client reports.",
  ...
  sections: [
    {
      ...
      body: "Broad automation suites can be powerful, but they also add flow-builder weight. VisibleTrader DM keeps the campaign path tight: keyword, post, reply, link, result.",
    },
    {
      title: "Agency proof",
  ...
  comparisonTitle: "VisibleTrader DM vs broad chatbot builders",
  comparisons: [
    {
      label: "Setup",
  ...
  faqs: [
    {
      title: "Is VisibleTrader DM a full Manychat replacement?",
      body: "No. VisibleTrader DM is intentionally focused on Instagram comment-to-DM campaigns. If you need a complete chatbot suite, use a broad platform. If you need fast campaign loops, VisibleTrader DM is built for that.",
    },
    {
...
export const agenciesSeoPage: SeoPageConfig = {
  ...
  description:
    "VisibleTrader DM gives agencies multi-account workspaces, client-ready reports, tracked links, and a focused comment-to-DM workflow for repeatable Instagram campaigns.",
...
export const commentLinkSeoPage: SeoPageConfig = {
  ...
  faqs: [
    ...
    {
      title: "Does VisibleTrader DM send a normal Instagram DM?",
