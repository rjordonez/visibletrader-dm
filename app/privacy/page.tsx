...
export const metadata: Metadata = {
  title: "Privacy Policy - VisibleTrader DM",
  description:
    "How VisibleTrader DM handles Instagram account data, webhook payloads, billing data, and customer campaign information.",
};
...
export default function PrivacyPage() {
  return (
    <LegalShell
      ...
      description="VisibleTrader DM helps businesses send Meta-compliant private replies when people comment on connected Instagram posts or reels."
    ...
    >
      ...
      <section>
        ...
        <p className="mt-3">
          VisibleTrader DM does not ask for Instagram passwords, scrape Instagram, or
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          the support email configured for the hosted VisibleTrader DM service.
        </p>
      </section>
    </LegalShell>
  );
