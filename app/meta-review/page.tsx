...
export const metadata: Metadata = {
  title: "Meta App Review Support - VisibleTrader DM",
  description:
    "Meta App Review notes for VisibleTrader DM's official Instagram private reply workflow.",
};
...
export default function MetaReviewPage() {
  return (
    <LegalShell
      ...
      description="VisibleTrader DM is designed for Instagram professional accounts that want to send private replies after keyword comments on their own posts or reels."
    ...
    >
      <section>
        ...
        <p className="mt-3">
          ...
          reel, and receives a webhook when someone comments. VisibleTrader DM queues
